...
// Creating new order by selecting property group
CustomKeywords.'webAutomation.OrderPage.createOrderAfterSelectingPropertyGroup'(products, row, group, paymentMode, paymentPeriod)