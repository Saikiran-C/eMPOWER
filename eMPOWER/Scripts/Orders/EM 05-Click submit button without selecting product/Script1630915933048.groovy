...
def paymentPeriod = "7";
def message = "You need at least one product in order to create the order."
...
// Verifying the error message without adding the product
CustomKeywords.'webAutomation.OrderPage.validateErrorMessageWithoutProduct'(paymentMode, paymentPeriod, message);