...
def products = [["Heaven Mosquito Coil","2"]];
def row = "0";
def customerName = "Anthony Baidoo";
def expectedDiscount = "1%"
...
// Verifying the discount value of product
CustomKeywords.'webAutomation.OrderPage.verifyDiscountValue'(products, row, expectedDiscount)