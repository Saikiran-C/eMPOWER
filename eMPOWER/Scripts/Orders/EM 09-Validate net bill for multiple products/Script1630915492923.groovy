...
def products = [["Cocoasett","201"],["Fertilizer Applicator","201"]]
...
// Verifying the net price value for multiple products
CustomKeywords.'webAutomation.OrderPage.compareNetPriceValuesFromTableForMultipleProducts'(products, row1, row2)