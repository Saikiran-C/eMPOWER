...
def products = [["Cocoasett","201"],["Fertilizer Applicator","201"],["Rain Coat","1"]];
...
// Creating the new order with multiple products based on input
CustomKeywords.'webAutomation.OrderPage.createOrder'(paymentMode, paymentPeriod, products)