...
// Clicking on cancel button after entering the details
CustomKeywords.'webAutomation.OrderPage.validateCancelButtonAfterFillingDetails'(paymentMode, paymentPeriod, products)