...
// Creating the new order based on input
...
// Verifying net price values of products
CustomKeywords.'webAutomation.OrderPage.compareNetPriceValuesFromTable'(products, row)